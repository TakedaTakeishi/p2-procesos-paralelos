...
En la arquitectura de sistemas operativos modernos, el archivo es la abstracción universal. Bajo la premisa de "todo es un archivo", el sistema operativo permite interactuar de manera uniforme con discos duros, terminales, tuberías, sockets de red e incluso memoria física
